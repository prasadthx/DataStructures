...
//                operand_2 = strcpy(operand_2, operands.pop());
//                operand_1 = strcpy(operand_1, operands.pop());
                tempString = new char[20];
//                cout << *operands.StackArr[operands.Top] << endl;
//                operand_2 = new char[20];
...
//                operands.push(tempChar);
//                operands.push(operand_2);
//                operands.push(')');
                strcpy(tempString,"(");
